...
set "%~1dependencies= "
set "%~1dev_dependencies=input_string strip_dquotes capchar"
...
:doc.demo
call :input_string --optional wildcard_path || set "wildcard_path=*:\Windows\Sys*\*script.exe"
call :strip_dquotes --optional wildcard_path
